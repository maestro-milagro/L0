...
func (r *PaymentsPostgres) Create(messageId int, pay message.Payments) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
	...
	var id int
	createListQuery := fmt.Sprintf("INSERT INTO %s VALUES (default, $1, $2, $3, $4, $5, $6, $7, $8, $10, $11, $12, $13, $14) RETURNING id", Payments)
